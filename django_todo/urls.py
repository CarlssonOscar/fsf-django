...
urlpatterns = [
    ...
    # links or forms in our templates. Through the URL and into
    #  the view which expects it as a parameter.After importing
    #  the Edit item view we should now be able to click the links on the home page.
